...
"Exalead Cloudview":http://www.exalead.com/software/products/cloudview/ 5 is delivered with an "Eclipse":http://www.eclipse.org/ project for the Search UI Application Interface, this application is build on "Spring":http://www.springsource.org/ 2.4.4.

<h2>The Problem</h2>
<p>When importing the project into my "RAD":http://www-01.ibm.com/software/awdtools/developer/application/, I got the following error ( see the full stack trace at the end of the post ):
</p>    
<div class="code">
{% highlight java %}
...
<h2>The Cause</h2>
<p>
As explain by Juergen Hoeller at <a href="https://jira.springsource.org/browse/SPR-4788">NPE in GenericTypeResolver when...</a>
<q>
This seems to be caused by a slightly different implementation of the "java.beans.PropertyDescriptor" class in IBM's JDK class libraries... breaking an assumption in Spring's GenericTypeAwarePropertyDescriptor subclass...
</q>
</p>

<h2>The Solution</h2>

<p>Upgrade to Spring 2.5.5.</p>
