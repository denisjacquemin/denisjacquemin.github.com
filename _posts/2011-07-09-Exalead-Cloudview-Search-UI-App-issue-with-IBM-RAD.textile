...
For sure the application works perfectly on tomcat, but on websphere that's another story. 
...
Spring 2.4.4 has problems running with RAD, as explained by Juergen Hoeller at "NPE in GenericTypeResolver when...":https://jira.springsource.org/browse/SPR-4788 
